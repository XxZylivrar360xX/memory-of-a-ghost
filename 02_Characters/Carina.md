...
**Nightstalker (Vacío) — leer el campo como lee a la gente.** Shadowshot no es solo control de área: es la misma habilidad que usa para encontrar qué conecta a las personas, aplicada al espacio de batalla. **No disponible en Age I** (precedente real de Destiny 1: Nightstalker se introdujo con House of Wolves, no venía en el juego base). **Origen real (corregido 2026-08-12):** despierta como chispa cruda y sin nombre en las ruinas caídas del Jardín Negro en Marte (Book 02, Cap. 15, `The Third Element`), Taken King — y se forma completa, con nombre y control total, apenas un capítulo después, en Eirene (Book 02, Cap. 16, `09_Eirene.md`), atando a Oryx el tiempo justo para sacar a Kyle con vida de un duelo que estaba perdiendo contra él. No es práctica gradual — es necesidad absoluta encontrando de golpe la forma que llevaba semanas buscando. Para cuando llega a la batalla sobre la Tierra al final de Season of the Seraph — el mismo momento de "Síguelo" —, tejer el flanco que ella y Jaden sostienen mientras Kyle se va solo hacia Neomuna ya es un gesto de años de práctica, no un estreno. *(Corrección 2026-08-12, autorizada por el autor: la nota anterior fijaba la formación completa en Season of the Seraph, dejando el despertar crudo del Cap. 15 esperando años para madurar — ver footer de `08_The_Third_Element.md`. El duelo de Eirene comprime ese salto: el dominio nace bajo presión extrema, no por entrenamiento largo. Corrección previa, 2026-08-02: la nota anterior a esa decía "esa misma campaña" refiriéndose a House of Wolves, contradiciendo que Lena muere en Taken King, ya fijado en todo Book 02 Part 01.)* Ver hilo pendiente en Arcstrider, arriba.
