...
**Nightstalker (Vacío) — leer el campo como lee a la gente.** Shadowshot no es solo control de área: es la misma habilidad que usa para encontrar qué conecta a las personas, aplicada al espacio de batalla. La usa, con nombre y control completo por primera vez, en la batalla sobre la Tierra al final de Season of the Seraph — el mismo momento de "Síguelo" — tejiendo el flanco que ella y Jaden sostienen mientras Kyle se va solo hacia Neomuna. **No disponible en Age I** (precedente real de Destiny 1: Nightstalker se introdujo con House of Wolves, no venía en el juego base). **Origen real (corregido 2026-08-02):** no se desbloquea formada — despierta como chispa cruda y sin nombre en las ruinas caídas del Jardín Negro en Marte (Book 02, Cap. 15, `The Third Element`), Taken King, el mismo período en que pierde a Lena — mismo patrón que Kyle con Stormtrance/Chaos Reach: el despertar crudo llega primero, el dominio nombrado llega años después. *(Corrección de continuidad: la nota anterior decía "esa misma campaña" refiriéndose a House of Wolves, contradiciendo que Lena muere en Taken King, ya fijado en todo Book 02 Part 01 — error de una fase de diseño anterior a que esa cronología quedara firme.)* Ver hilo pendiente en Arcstrider, arriba.
