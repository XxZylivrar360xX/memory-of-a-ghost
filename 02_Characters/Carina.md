...
**Nightstalker (Vacío) — leer el campo como lee a la gente.** Shadowshot no es solo control de área: es la misma habilidad que usa para encontrar qué conecta a las personas, aplicada al espacio de batalla. La usa, con nombre y lugar, en la batalla sobre la Tierra al final de Season of the Seraph — el mismo momento de "Síguelo" — tejiendo el flanco que ella y Jaden sostienen mientras Kyle se va solo hacia Neomuna. **No disponible en Age I** (precedente real de Destiny 1: Nightstalker se introdujo con House of Wolves, no venía en el juego base) — se desbloquea para ella recién en esa misma campaña, el mismo período en que pierde a Lena. Ver hilo pendiente en Arcstrider, arriba.
