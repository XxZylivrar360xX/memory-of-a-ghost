...
**Estado: arquitectura fijada; Prólogo completo (7/7 capítulos); Part 01 con interludio + Capítulos 8-11 escritos.**
...
1. **[Cap. 8] The Last Board** *(antes "The Porch")* — Kyle y Ghost en la cabaña, terminando de montar el porche — el mismo porche que va a ser testigo de la mayoría de los momentos domésticos importantes de Kyle en el resto de la saga. Catch-up nostálgico sobre Age I (Atheon, Crota/"Matadioses", Skolas); Elsie aparece brevemente en persona, consistente con su etapa de Observación — visita ocasional, sin convivencia ni romance adelantado — y le quita a Kyle la aguja con la que se estaba suturando mal un corte ("Dame eso", eco verbatim de la línea ya citada en `Guardian_Elsie_PostFinalShape_LoQueYaEraVerdad`), anclando ahí el origen real de esa cicatriz. Termina con la llamada de Ikora: la alarma de Phobos lleva tres días sonando sin parar, todavía activa. Material nuevo, sin escena fuente. **Estado: escrito** (`Part_01_Price_of_Vengeance/01_The_Last_Board.md`), pendiente de ajuste del autor.
