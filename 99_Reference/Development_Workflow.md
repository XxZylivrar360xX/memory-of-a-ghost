...
- **Codex — Auditoría de Consistencia + Incubadora de Ideas + Editorial de Postproducción.** Barrido estructural a escala de repo: enlaces rotos, índice desincronizado, cronologías contradictorias, duplicados. **Rol ampliado (2026-07-12):** también funciona como banca/incubadora de ideas — Víctor gesta escenas o conceptos con él y Codex los ancla contra el vault (qué los sostiene, qué contradicen, qué decisiones mínimas faltan) en notas `incubadora-*`; las que convencen a Víctor pasan a Claude Code, que crea el cimiento real en `07_Unsorted_Ideas/` citando la nota. **Formalización (2026-08-10):** para preguntas de canon de Destiny externo o que requieren explorar varias direcciones antes de decidir, este rol se apoya en `Codex_Canon_Researcher.md` y `Codex_Brainstorming_Agent.md` — ver `Codex_Brief.md` § "Formalización del rol". **Rol ampliado (2026-07-14):** absorbe también la Postproducción Narrativa que cubría el GPT "Editor — Renewed Fate" (deprecado — ver abajo): continuidad, semillas rotas, filosofía/identidad, simetrías. Es la **última compuerta antes del merge** en escenas philosophy-heavy, no solo un barrido periódico. **Rol ampliado (2026-07-26):** para capítulos de `11_Books/`, también es quien bautiza (propone o confirma) el título final al terminarse el capítulo — ver `Codex_Brief.md`, "Bautizo de capítulos". **Excepción de escritura (2026-07-26):** dentro de `11_Books/`, y solo cuando Víctor lo pide en la conversación, puede escribir directo en el repo para aplicar renombres de título (archivo + propagación completa) y ajustes de beats/secciones ya escritos dentro de un capítulo — ver `Codex_Brief.md`, "Escritura directa permitida en `11_Books/`". Fuera de esa excepción, **no escribe en el repo fuera de su carpeta de notas** ni decide canon; no redacta prosa nueva — su chequeo sigue siendo de anclaje y auditoría, no de dirección narrativa. (Ver `Codex_Brief.md`.)
...
Idea → Opus / brainstorm → .md → Unsorted_Ideas/
     (ruta alterna: Idea → Codex incuba/ancla contra el vault → nota incubadora-*
      ...
      — formalizada 2026-08-10 para preguntas Destiny-heavy o multi-opción:
      Codex Canon Research → Gap Analysis → Codex Brainstorming Agent → nota incubadora,
      ver `Codex_Brief.md` § "Formalización del rol")
...
*Conecta con: [[99_Reference/ChatGPT_Editor_Brief]], [[99_Reference/Codex_Brief]], [[99_Reference/Agent_Notes/README]], [[99_Reference/Editorial_Agent_Architecture]], [[99_Reference/Codex_Canon_Researcher]], [[99_Reference/Codex_Brainstorming_Agent]]*
